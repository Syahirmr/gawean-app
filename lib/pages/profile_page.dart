...
class _ProfilePageState extends State<ProfilePage> {
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              SliverToBoxAdapter(child: _buildGamifiedHeader()),
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    // Weekly Productivity Chart dengan data real - DIPERBAIKI
                    _buildProductivityChart(theme),
  ...
  Widget _buildStatsGrid(ThemeData theme) {
    ...
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        ...
        crossAxisSpacing: 8,
        mainAxisSpacing: 8,
        childAspectRatio: 1.2, // Diperkecil agar lebih padat
      ),
                ...
                Row(
                  children: [
                    Container(
                      ...
                      height: 40, // Lebih besar
                      decoration: BoxDecoration(
                        color: color.withOpacity(0.1),
                        borderRadius: BorderRadius.circular(8), // Lebih besar
                      ),
                      child: Icon(
                        stat['icon'] as IconData,
                        color: color,
                        size: iconSize, // Menggunakan size dari stat
                      ),
                    ),
                  ],
                ),
      ...
      child: Column(
        ...
        children: [
          ...
          LinearProgressIndicator(
            value: progress,
            backgroundColor: Colors.grey[200],
            valueColor: AlwaysStoppedAnimation<Color>(_getFocusColor(progress)),
  ...
  Widget _buildProductivityChart(ThemeData theme) {
    ...
    if (_weeklyStats.isNotEmpty) {
      spots = _weeklyStats.asMap().entries.map((entry) {
        ...
        return FlSpot(index.toDouble(), stat.productivityScore);
      }).toList();

      dayLabels = _weeklyStats.map((stat) {
    ...
    final avgProductivity = spots.isNotEmpty
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getChartColor(avgProductivity).withOpacity(0.1),
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(
                      color: _getChartColor(avgProductivity).withOpacity(0.2),
                      width: 0.5,
                    ),
                  ),
                  child: Row(
                    ...
                    children: [
                      Icon(
                        _getChartIcon(avgProductivity),
                        size: 13,
                        color: _getChartColor(avgProductivity),
                      ),
                      const SizedBox(width: 4),
                      Text(
                ...
                LineChartData(
                  ...
                  titlesData: FlTitlesData(
                    ...
                    bottomTitles: AxisTitles(
                      axisNameSize: 20, // More space for bottom titles
                      sideTitles: SideTitles(
                        showTitles: true,
                        reservedSize: 25, // Increased reserved space
                        interval: 1,
                      ...
                      getTooltipItems: (touchedSpots) {
                        return touchedSpots.map((touchedSpot) {
                          return LineTooltipItem(
                            '${dayLabels[touchedSpot.spotIndex.toInt()]}: ${touchedSpot.y.toStringAsFixed(1)}',
                            TextStyle(
                              color: theme.colorScheme.onSurface,
                              fontWeight: FontWeight.w600,
                            ),
  ...
  IconData _getChartIcon(double score) {
    if (score >= 3.5) return Icons.trending_up;
    if (score >= 2.0) return Icons.trending_flat;
    return Icons.trending_down;
  }

  Color _getChartColor(double score) {
  ...
  Widget _buildAchievementsSection(ThemeData theme) {
    ...
    final progress = _totalAchievements > 0
        ? earnedCount / _totalAchievements
        : 0.0;
      ...
      child: Column(
        ...
        children: [
          ...
          if (_achievements.isEmpty)
            Container(
              width: double.infinity, // Full width untuk empty state
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  // Progress bar untuk visual progress
                  Container(
            ...
            Container(
              ...
              child: GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 4,
                  crossAxisSpacing: 8, // Spacing lebih besar
                  mainAxisSpacing: 8,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          achievement.title,
                          style: TextStyle(
                            fontSize: 9, // Font sedikit lebih besar
                            fontWeight: FontWeight.w600,
                            color: theme.colorScheme.onSurface,
                          ),
                          textAlign: TextAlign.center,
  ...
  void _showAchievementDialog(Achievement achievement) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(achievement.title, style: const TextStyle(fontSize: 18)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.insights, color: theme.colorScheme.primary, size: 16),
  ...
  Widget _buildColorOption(Color color, String label) {
    return GestureDetector(
      onTap: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("$label theme color selected"),
              ...
              content: Column(
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    subtitle: const Text(
                      "Get notified when earning achievements",
                    ),
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text(
                "A: Complete quests and maintain streaks to earn XP.",
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const Text(
              "© 2024 Quest App. All rights reserved.",
